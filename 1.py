...
class SegmentationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        image = self.images[idx] / 10000.0  # Normalize
        mask = self.masks[idx]
...
if __name__ == '__main__':
    ...
    trained_model = train_model(
        ...
        lr=0.001, 
        device=device,
        use_focal_loss=True,  # Set to True if severe class imbalance
...
THis model is trained on sentinel data so do not assume 8bit channels.

Guide me on how to implement  random cutout with replacement of some other part of some other image. Horizontal flips and vertical flips during train.
